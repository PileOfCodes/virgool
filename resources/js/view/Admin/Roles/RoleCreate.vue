...
<p class="">نقش ها</p>
  ...
  <div class="flex flex-col mt-6">
    ...
    <button @click="saveRole" class="flex flex-row justify-center items-center text-white bg-sky-600 p-2 w-32 mt-2 rounded-md ">
...
export default {
    ...
    methods: {
        ...
        saveRole()
        {
            ...
            {
                this.loading = true
                axios.post(`/api/admin/roles`, this.role)
                .then(() => {
